...
@Table(name = "marital_status",
        uniqueConstraints = @UniqueConstraint(name = "uk_marital_status_code", columnNames = "marital_status_code"),
        indexes = @Index(name = "idx_marital_status_code", columnList = "marital_status_code")
)
@Data
@NoArgsConstructor
@AllArgsConstructor
